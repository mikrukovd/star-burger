...
Определите переменные окружения `SECRET_KEY` и [`YANDEX_GEOCODER_APIKEY`](https://developer.tech.yandex.ru/services). Создать файл `.env` в каталоге `star_burger/` и положите туда такой код:
```sh
SECRET_KEY=django-insecure-0if40nf4nf93n4
YANDEX_GEOCODER_APIKEY=apikey
```
...
- `YANDEX_GEOCODER_APIKEY` - [Api Геокодера](https://developer.tech.yandex.ru/services)
